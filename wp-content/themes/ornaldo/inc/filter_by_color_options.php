...
class FTC_Product_Filter_By_Color{
	...
	function edit_color_attribute( $term, $taxonomy ){
		...
		?>
		<tr class="form-field">
			<th scope="row" valign="top"><label><?php esc_html_e( 'Color', 'ornaldo' ); ?></label></th>
			<td>
				...
				<span class="description"><?php esc_html_e('Use color picker to pick one color.','ornaldo'); ?></span>
			</td>
		</tr>

		<tr class="form-field">
			<th scope="row" valign="top"><label><?php esc_html_e( 'Thumbnail Image', 'ornaldo' ); ?></label></th>
			<td>
			...
			jQuery(document).ready(function(){
				...
				jQuery(document).on( 'click', '.ftc_color_upload_image_button', function( event ){
					...
					file_frame = wp.media.frames.downloadable_file = wp.media({
						title: '<?php esc_html_e( 'Choose an image', 'ornaldo' ); ?>',
						button: {
							text: '<?php esc_html_e( 'Use image', 'ornaldo' ); ?>',
						},
						multiple: false
					});
	...
	function add_color_attribute(){
		...
		<div class="form-field">
			<label><?php esc_html_e( 'Color', 'ornaldo' ); ?></label>
			...
			<p class="description"><?php esc_html_e('Use color picker to pick one color.','ornaldo'); ?></p>
		</div>

		<div class="form-field">
			<label><?php esc_html_e( 'Thumbnail Image', 'ornaldo' ); ?></label>
	...
	function save_color_fields( $term_id, $tt_id, $taxonomy ){
		if( isset($_POST['ftc_color_color'], $_POST['ftc_color_image']) ){
			$datas = array();
			$datas['ftc_color_color'] = sanitize_text_field($_POST['ftc_color_color']);
			$datas['ftc_color_image'] = sanitize_text_field($_POST['ftc_color_image']);
