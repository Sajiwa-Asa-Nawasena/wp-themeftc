						...
						<div class="entry-content">	
							...
							<div class="meta-content">
								...
								<div class="portfolio-info">
									<p class="ptsan"><?php esc_html_e('Date:', 'ornaldo') ?></p>
								...
								if ( $categories_list ):
									?>
									<div class="portfolio-info">
										<p class="ptsan"><?php esc_html_e('Categories:', 'ornaldo'); ?></p>
							...
							<div class="single-navigation">
								<?php
								previous_post_link('%link', esc_html__('Prev Project', 'ornaldo'));
								next_post_link('%link', esc_html__('Next Project', 'ornaldo'));
								?>
							</div>
