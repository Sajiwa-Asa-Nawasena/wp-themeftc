...
<body <?php body_class(); ?>>
    ...
    <div id="page" class="site-header header7">
        <?php if( !is_page_template('page-blank.php') ): ?>
        <header id="masthead" class="site-header header7">
            ...
            <div class="header-ftc header-<?php echo esc_attr($smof_data['ftc_header_layout']); ?>">
                ...
                <div class="header-content <?php echo esc_attr(implode(' ', $header_classes)); ?>">
                    <div class="container">
                        ...
                        <div class="ftc-search-product search-shop-hidden"><?php ftc_get_search_form_by_category(); ?></div>
                        <?php endif; ?>
