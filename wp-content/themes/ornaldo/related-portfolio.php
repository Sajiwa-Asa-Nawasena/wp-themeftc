...
?>
	<div class="related-posts related related-portfolio <?php echo esc_attr(($is_slider)?'loading':'') ?>" id="<?php echo esc_attr($rand_id); ?>">
		<header class="theme-title">
			<h3 class="heading-title"><?php esc_html_e('Related Portfolio', 'ornaldo'); ?></h3>
			<div class="sub-title">
				<span class="content-title">A perfect blend of creativity, energy, communication, happiness and love.<br> Let us arrange a smile for you.</span>
			</div>
		</header>
