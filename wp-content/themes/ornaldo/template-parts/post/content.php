...
<article <?php post_class($post_class) ?>>
		...
		<div class="post-info">
			...
			<div class="entry-info">
				...
				<?php if( $smof_data['ftc_blog_title'] ): ?>
					...
					<?php if ( is_sticky() && is_home() && ! is_paged() ): {
						printf( '<span class="sticky-post">%s</span>', esc_html__( 'Featured', 'ornaldo' ) );
					}?>
			...
			if ( ($categories_list && $smof_data['ftc_blog_categories']) || $smof_data['ftc_blog_author'] ): 
				...
				<?php if( $smof_data['ftc_blog_author'] ): ?>
					...
					<span><?php esc_html_e('Posted by: ', 'ornaldo'); ?></span>
			...
			<span class="tags-link">
				<span><?php esc_html_e('Tags: ','ornaldo');?></span>
	...
	<div class="entry-summary">
		...
		<?php if( $smof_data['ftc_blog_read_more'] ): ?>
			<a class="button-readmore" href="<?php the_permalink() ; ?>"><?php esc_html_e('Read More', 'ornaldo'); ?></a>
		<?php endif; ?>
	</div>
</div>
