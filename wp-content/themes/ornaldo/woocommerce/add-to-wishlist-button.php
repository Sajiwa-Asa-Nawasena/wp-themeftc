...
<img src="<?php echo esc_html(get_template_directory_uri()) . '/assets/images/ajax-loader.gif'; ?>" class="ajax-loading" alt="loading" width="16" height="16" style="visibility:hidden" />