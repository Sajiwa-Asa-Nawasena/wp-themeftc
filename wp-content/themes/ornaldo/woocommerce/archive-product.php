		...
		<div id="main-content" class="<?php echo esc_attr($page_column_class['main_class']); ?>">	
			...
			if (isset($smof_data['ftc_advanced_filter_product_shop']) && $smof_data['ftc_advanced_filter_product_shop']) {
				...
				<ul class="ftc-product-tabs-filter">
					<li data-filter="*" class="current"><?php echo esc_html__('All','ornaldo') ?></li>
					<li data-filter=".featured" class=""><?php echo esc_html__('Hot Products','ornaldo'); ?></li>
					<li data-filter=".sale" class=""><?php echo esc_html__('Sales Products', 'ornaldo'); ?></li>
					<li data-filter=".variable" class=""><?php echo esc_html__('Variation Products', 'ornaldo'); ?></li>                               
				</ul>
				<?php
			}
			?>
