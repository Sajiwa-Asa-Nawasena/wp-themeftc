            ...
            <img src="<?php echo esc_url($store_user->get_banner()); ?>"
                 ...
                 class="profile-info-img">
                  ...
                  <div class="social-store">
                        ...
                        <li class="pinterest">
                            <a class="pinterest social-icon" href=<?php echo esc_url("https://www.pinterest.com/shareArticle?mini=true&url=" . get_the_permalink() ) ?> target="_blank" title="<?php echo esc_attr__('Pinterest', 'ornaldo'); ?>"><i class="fa fa-pinterest-p"></i></a>
                        </li>
                        <li class="gplus">
    ...
    <div class="dokan-store-tabs<?php echo  esc_attr($no_banner_class_tabs); ?>">
        <ul class="dokan-list-inline">
            <?php foreach( $store_tabs as $key => $tab ) { ?>
                <li><a href="<?php echo esc_url( $tab['url'] ); ?>"><?php echo  esc_attr($tab['title']); ?></a></li>
            <?php } ?>
