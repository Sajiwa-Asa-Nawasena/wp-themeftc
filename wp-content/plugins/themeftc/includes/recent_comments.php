...
if( !class_exists('Ftc_Recent_Comments_Widget') ){
	class Ftc_Recent_Comments_Widget extends WP_Widget {
		...
		function __construct() {
			$widgetOps = array('classname' => 'ftc-recent-comments-widget', 'description' => esc_html__('Display recent comments on site', 'ornaldo'));
			parent::__construct('ftc_recent_comments', esc_html__('FTC - Recent Comments', 'ornaldo'), $widgetOps);
		}
		...
		function widget( $args, $instance ) {
							...
							<li>
								<div class="comment-meta">
									...
									<div class="meta">
										...
										<?php if( $show_post_on ): ?>       
											<p class="on_post"><?php echo esc_html__('on', 'ornaldo') ?> <a href="<?php echo get_permalink($comment->comment_post_ID) ?>"><?php echo get_the_title($comment->comment_post_ID) ?></a> </p>
										<?php endif; ?>
									</div>
								</div>
			...
			function form( $instance ) {
				...
				$post_types = array_merge(array('all'=>esc_html__('All Posts', 'ornaldo')), $post_types);
				...
				<p>
					<label for="<?php echo esc_attr($this->get_field_id('post_type')); ?>"><?php echo esc_html_e('Post type', 'ornaldo'); ?> </label>
				...
				<p>
					<label for="<?php echo esc_attr($this->get_field_id('limit')); ?>"><?php esc_html_e('Number of comments to show', 'ornaldo'); ?> </label>
				...
				<p>
					...
					<label for="<?php echo esc_attr($this->get_field_id('show_avatar')); ?>"><?php esc_html_e('Show avatar', 'ornaldo'); ?></label>
				</p>
				...
				<p>
					...
					<label for="<?php echo esc_attr($this->get_field_id('show_date')); ?>"><?php esc_html_e('Show comment date', 'ornaldo'); ?></label>
				</p>
				...
				<p>
					...
					<label for="<?php echo esc_attr($this->get_field_id('show_author')); ?>"><?php esc_html_e('Show comment author', 'ornaldo'); ?></label>
				</p>
				...
				<p>
					...
					<label for="<?php echo esc_attr($this->get_field_id('show_comment')); ?>"><?php esc_html_e('Show comment content', 'ornaldo'); ?></label>
				</p>
				...
				<p>
					...
					<label for="<?php echo esc_attr($this->get_field_id('show_post_on')); ?>"><?php esc_html_e('Show post on', 'ornaldo'); ?></label>
				</p>
