...
if(!class_exists('Ftc_Product_Categories_Widget')){
    class Ftc_Product_Categories_Widget extends WP_Widget {
        ...
        function __construct() {
            $widgetOps = array('classname' => 'ftc-product-categories-widget', 'description' => esc_html__('Display Your Product Categories', 'ornaldo'));
            parent::__construct('ftc_product_categories', esc_html__('FTC - Product Categories', 'ornaldo'), $widgetOps);
        }
        ...
        function form( $instance ) { 
            ...
            <p>
                ...
                <label for="<?php echo esc_attr($this->get_field_id('show_post_count')); ?>"><?php esc_html_e('Show post count', 'ornaldo'); ?></label>
            </p>
            <p>
                ...
                <label for="<?php echo esc_attr($this->get_field_id('show_icon')); ?>"><?php esc_html_e('Show icon', 'ornaldo'); ?></label>
            </p>
            <p>
                ...
                <label for="<?php echo esc_attr($this->get_field_id('show_sub_cat')); ?>"><?php esc_html_e('Show sub categories', 'ornaldo'); ?></label>
            </p>
            <p>
                ...
                <label for="<?php echo esc_attr($this->get_field_id('hide_empty')); ?>"><?php esc_html_e('Hide empty categories', 'ornaldo'); ?></label>
            </p>
            <p>
                ...
                <span class="description"><?php esc_html_e("Don't select to show all", "ornaldo"); ?></span>
            </p>
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('orderby')); ?>"><?php esc_html_e('Order by', 'ornaldo'); ?></label>
                <select class="widefat" id="<?php echo esc_attr($this->get_field_id('orderby')); ?>" name="<?php echo esc_attr($this->get_field_name('orderby')); ?>" >
                    <option value="name" <?php selected($instance['orderby'], 'name'); ?> ><?php esc_html_e('Name', 'ornaldo'); ?></option>
                    <option value="slug" <?php selected($instance['orderby'], 'slug'); ?> ><?php esc_html_e('Slug', 'ornaldo'); ?></option>
                    <option value="count" <?php selected($instance['orderby'], 'count'); ?> ><?php esc_html_e('Number product', 'ornaldo'); ?></option>
                    <option value="rand" <?php selected($instance['orderby'], 'rand'); ?> ><?php esc_html_e('Random', 'ornaldo'); ?></option>
                    <option value="none" <?php selected($instance['orderby'], 'none'); ?> ><?php esc_html_e('None', 'ornaldo'); ?></option>
                </select>
            </p>
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('order')); ?>"><?php esc_html_e('Order', 'ornaldo'); ?></label>
                <select class="widefat" id="<?php echo esc_attr($this->get_field_id('order')); ?>" name="<?php echo esc_attr($this->get_field_name('order')); ?>" >
                    <option value="asc" <?php selected($instance['order'], 'asc'); ?> ><?php esc_html_e('Ascending', 'ornaldo'); ?></option>
                    <option value="desc" <?php selected($instance['order'], 'desc'); ?> ><?php esc_html_e('Descending', 'ornaldo'); ?></option>
                </select>
            </p>
