...
if( !class_exists('Ftc_Products_Widget') ){
	class Ftc_Products_Widget extends WP_Widget {
		...
		function __construct() {
			$widgetOps = array('classname' => 'ftc-items-widget', 'description' => esc_html__('Display your products on site','ornaldo'));
			parent::__construct('ftc_products', esc_html__('FTC - Products','ornaldo'), $widgetOps);
		}
		...
		function widget( $args, $instance ) {
						...
						<?php if( $count % $row == 0 ): ?>
							...
							<li>
								<a class="ftc-widget-image" href="<?php echo esc_url( get_permalink($product->get_id()) ); ?>" title="<?php echo esc_attr( $product->get_title() ); ?>">
									...
									if ( $show_thumbnail ) {
										if( !$lazy_load ){
											print_r($product->get_image($thumbnail_size));
										}
										else{
			...
			function form( $instance ) {
				...
				?>
				<p>
					<label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php esc_html_e('Enter your title', 'ornaldo'); ?> </label>
					<input class="widefat" id="<?php echo esc_attr($this->get_field_id('title')); ?>" name="<?php echo esc_attr($this->get_field_name('title')); ?>" type="text" value="<?php echo esc_attr($instance['title']); ?>" />
				</p>

				<p>
					<label for="<?php echo esc_attr($this->get_field_id('product_type')); ?>"><?php esc_html_e('Product type', 'ornaldo'); ?> </label>
					<select class="widefat" id="<?php echo esc_attr($this->get_field_id('product_type')); ?>" name="<?php echo esc_attr($this->get_field_name('product_type')); ?>">
						<option value="recent" <?php selected($instance['product_type'], 'recent'); ?>><?php esc_html_e('Recent', 'ornaldo'); ?></option>
						<option value="sale" <?php selected($instance['product_type'], 'sale'); ?>><?php esc_html_e('Sale', 'ornaldo'); ?></option>
						<option value="featured" <?php selected($instance['product_type'], 'featured'); ?>><?php esc_html_e('Featured', 'ornaldo'); ?></option>
						<option value="best_selling" <?php selected($instance['product_type'], 'best_selling'); ?>><?php esc_html_e('Best selling', 'ornaldo'); ?></option>
						<option value="top_rated" <?php selected($instance['product_type'], 'top_rated'); ?>><?php esc_html_e('Top rated', 'ornaldo'); ?></option>
						<option value="mixed_order" <?php selected($instance['product_type'], 'mixed_order'); ?>><?php esc_html_e('Mixed order', 'ornaldo'); ?></option>
					</select>
				</p>

				<p>
					<label><?php esc_html_e('Select categories', 'ornaldo'); ?></label>
					<div class="categorydiv">
						<div class="tabs-panel">
							<ul class="categorychecklist">
								...
								<li>
									<label>
										<input type="checkbox" name="<?php echo esc_attr($this->get_field_name('product_cats')); ?>[<?php esc_attr($cat->term_id); ?>]" value="<?php echo esc_attr($cat->term_id); ?>" <?php echo (in_array($cat->term_id,$instance['product_cats']))?'checked':''; ?> />
				...
				<p>
					<label for="<?php echo esc_attr($this->get_field_id('row')); ?>"><?php esc_html_e('Number of rows - in carousel slider', 'ornaldo'); ?> </label>
				...
				<p>
					<label for="<?php echo esc_attr($this->get_field_id('limit')); ?>"><?php esc_html_e('Number of posts to show', 'ornaldo'); ?> </label>
				...
				<p>
					...
					<label for="<?php echo esc_attr($this->get_field_id('show_thumbnail')); ?>"><?php esc_html_e('Show thumbnail', 'ornaldo'); ?></label>
				</p>

				<p>
					<label for="<?php echo esc_attr($this->get_field_id('thumbnail_size')); ?>"><?php esc_html_e('Thumbnail size', 'ornaldo'); ?> </label>
					<select class="widefat" id="<?php echo esc_attr($this->get_field_id('thumbnail_size')); ?>" name="<?php echo esc_attr($this->get_field_name('thumbnail_size')); ?>">
						<option value="shop_thumbnail" <?php selected($instance['thumbnail_size'], 'shop_thumbnail'); ?>><?php esc_html_e('Product Thumbnails', 'ornaldo'); ?></option>
						<option value="shop_catalog" <?php selected($instance['thumbnail_size'], 'shop_catalog'); ?>><?php esc_html_e('Catalog Images', 'ornaldo'); ?></option>
						<option value="shop_single" <?php selected($instance['thumbnail_size'], 'shop_single'); ?>><?php esc_html_e('Single Product Image', 'ornaldo'); ?></option>
					</select>
				</p>
				...
				<p>
					...
					<label for="<?php echo esc_attr($this->get_field_id('show_categories')); ?>"><?php esc_html_e('Show categories', 'ornaldo'); ?></label>
				</p>
				...
				<p>
					...
					<label for="<?php echo esc_attr($this->get_field_id('show_product_title')); ?>"><?php esc_html_e('Show product title', 'ornaldo'); ?></label>
				</p>
				...
				<p>
					...
					<label for="<?php echo esc_attr($this->get_field_id('show_price')); ?>"><?php esc_html_e('Show price', 'ornaldo'); ?></label>
				</p>
				...
				<p>
					...
					<label for="<?php echo esc_attr($this->get_field_id('show_rating')); ?>"><?php esc_html_e('Show rating', 'ornaldo'); ?></label>
				</p>
				...
				<p>
					...
					<label for="<?php echo esc_attr($this->get_field_id('is_slider')); ?>"><?php esc_html_e('Show in a carousel slider', 'ornaldo'); ?></label>
				</p>
				...
				<p>
					...
					<label for="<?php echo esc_attr($this->get_field_id('show_nav')); ?>"><?php esc_html_e('Show navigation button', 'ornaldo'); ?></label>
				</p>
				...
				<p>
					...
					<label for="<?php echo esc_attr($this->get_field_id('auto_play')); ?>"><?php esc_html_e('Auto play', 'ornaldo'); ?></label>
				</p>
			...
			function get_list_sub_categories( $cat_parent_id, $instance ){
				...
				if( count($sub_categories) > 0){
					...
					<ul class="children">
						...
						<li>
							<label>
								<input type="checkbox" name="<?php echo esc_attr($this->get_field_name('product_cats')); ?>[<?php esc_attr($sub_cat->term_id); ?>]" value="<?php echo esc_attr($sub_cat->term_id); ?>" <?php echo (in_array($sub_cat->term_id,$instance['product_cats']))?'checked':''; ?> />
