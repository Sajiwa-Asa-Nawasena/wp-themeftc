...
if( !class_exists('Ftc_Feedburner_Subscription_Widget') ){
	class Ftc_Feedburner_Subscription_Widget extends WP_Widget {
		...
		function __construct() {
			$widgetOps = array('classname' => 'newletter_sub', 'description' => esc_html__('Display Feedburner Subscriptions Form','ornaldo'));
			$controlOps = array('width' => 400, 'height' => 550);
			parent::__construct('ftc_feedburner_subscription', esc_html__('FTC - Feedburner Subscription','ornaldo'), $widgetOps, $controlOps);
		}
		...
		?>
			<p>
                            <label for="<?php echo esc_attr($this->get_field_id('feedburner_id')); ?>"><?php esc_html_e('Enter your Feedburner ID', 'ornaldo'); ?> </label>
			...
			<p>
                            <label for="<?php echo esc_attr($this->get_field_id('intro_text')); ?>"><?php esc_html_e('Enter your Intro Text Line 1', 'ornaldo'); ?> </label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('button_text')); ?>"><?php esc_html_e('Enter your button text', 'ornaldo'); ?> </label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('placeholder_text')); ?>"><?php esc_html_e('Placeholder text', 'ornaldo'); ?> </label>
